...
def split_and_get_features(data, target_column='cnt', training_mode=False):
    if training_mode:
        ...
        cols = [col for col in data.columns if col not in ['date', 'date_id', "year", target_column]]
        data = data[cols]
...
class LGBMDataset:
    def __init__(self, file_path, training_mode=False):
        ...
        if self.training_mode:
            ...
            self.data = split_and_get_features(self.data, self.training_mode)
